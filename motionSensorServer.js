...
mongoose.connect(
  "mongodb+srv://ameyamahankal:4mq7FaDOD8LzQg18@cluster0.sjpz1jh.mongodb.net/",
  {
  ...
  try {
    while (true) {
      const response = await axios.get(
        "http://localhost:3000/motion/getMotion"
      );
    ...
    console.error(
      "Error getting motion data from Express server:",
      error.message
    );
  }
};
